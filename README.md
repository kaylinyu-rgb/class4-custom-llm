...
My files are plain UTF-8 text and Markdown that I wrote myself; no PDFs, no outside material. The course starter Git-ignores `corpus/`, but I committed mine on purpose.
